...
ALTER TABLE lesson ADD CONSTRAINT lesson_subject_num_fk FOREIGN KEY ( num ) REFERENCES subject ( num );
...
ALTER TABLE student ADD CONSTRAINT student_subject_num_fk FOREIGN KEY ( num ) REFERENCES subject ( num ) ON DELETE CASCADE; -- 부모의 num이 없어지면 자기도 없어짐
...
ALTER TABLE trainee ADD CONSTRAINT trainee_student_code_fk FOREIGN KEY ( code ) REFERENCES student ( code );
ALTER TABLE trainee ADD CONSTRAINT trainee_subject_num_fk FOREIGN KEY ( num ) REFERENCES subject ( num );
